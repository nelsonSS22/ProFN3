...
CREATE TABLE `inscripciones` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_inscripcion` (`usuario_id`,`clase_id`),
...
CREATE TABLE `usuarios` (
  ...
  KEY `clase_id` (`clase_id`),
  KEY `rol_id` (`rol_id`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`clase_id`) REFERENCES `clases` (`id`),
...
INSERT INTO `usuarios` VALUES (2,NULL,'Maestro','Apellido','maestro@example.com','contrasena123','Dirección 456','1980-05-20',NULL,NULL);
...
-- Dump completed on 2023-11-30 10:49:32
